const experiences = {
    ...
    "data": [
        ...
        },
        {
            ...
            "fromDate": "May 2016",
            "toDate": "Dec 2016",
            "description": "<ul><li> Supported e-Learning implementation platform (BlackBoard).</li><li> Developed mobile application for dissemination of teaching materials.</li><li> Optimized processes to get essential information from data sets.</li></ul>",
        ...
        },
        {
            ...
            "fromDate": "Mar 2016",
            "toDate": "Apr 2016",
            "description": "<ul><li> Developed and launched web applications, such as: corporate sites, portals and platforms. Considering programming methodologies.</li></ul>",
